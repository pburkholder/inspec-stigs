...
title 'WN12-CC-000022 - Device metadata retrieval from the Internet must be prevented.'

control 'WN12-CC-000022' do
  impact 0.1
...
'
  tag 'stig','WN12-CC-000022'
  tag severity: 'low'
  tag checkid: 'C-WN12-CC-000022_chk'
  tag fixid: 'F-WN12-CC-000022_fix'
  tag version: 'WN12-CC-000022'
  tag ruleid: 'WN12-CC-000022_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-CC-000022
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-CC-000022
