...
title 'WN12-AU-000002 - The system must be configured to audit Account Logon - Credential Validation failures.'

control 'WN12-AU-000002' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000002'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000002_chk'
  tag fixid: 'F-WN12-AU-000002_fix'
  tag version: 'WN12-AU-000002'
  tag ruleid: 'WN12-AU-000002_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000002
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000002
