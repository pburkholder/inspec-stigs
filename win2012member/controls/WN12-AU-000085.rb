...
title 'WN12-AU-000085 - The system must be configured to audit Policy Change - Audit Policy Change successes.'

control 'WN12-AU-000085' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000085'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000085_chk'
  tag fixid: 'F-WN12-AU-000085_fix'
  tag version: 'WN12-AU-000085'
  tag ruleid: 'WN12-AU-000085_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000085
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000085
