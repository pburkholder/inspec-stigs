...
title 'WN12-AU-000110 - The system must be configured to audit System - Security System Extension failures.'

control 'WN12-AU-000110' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000110'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000110_chk'
  tag fixid: 'F-WN12-AU-000110_fix'
  tag version: 'WN12-AU-000110'
  tag ruleid: 'WN12-AU-000110_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000110
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000110
