...
title 'WN12-AU-000015 - The system must be configured to audit Account Management - Other Account Management Events successes.'

control 'WN12-AU-000015' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000015'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000015_chk'
  tag fixid: 'F-WN12-AU-000015_fix'
  tag version: 'WN12-AU-000015'
  tag ruleid: 'WN12-AU-000015_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000015
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000015
