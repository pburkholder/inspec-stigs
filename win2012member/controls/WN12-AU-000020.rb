...
title 'WN12-AU-000020 - The system must be configured to audit Account Management - User Account Management failures.'

control 'WN12-AU-000020' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000020'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000020_chk'
  tag fixid: 'F-WN12-AU-000020_fix'
  tag version: 'WN12-AU-000020'
  tag ruleid: 'WN12-AU-000020_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000020
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000020
