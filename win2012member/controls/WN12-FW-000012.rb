...
title 'WN12-FW-000012 - The Windows Firewall must allow outbound connections, unless a rule explicitly blocks the connection for the Private Profile.'

control 'WN12-FW-000012' do
  impact 0.5
...
'
  tag 'stig','WN12-FW-000012'
  tag severity: 'medium'
  tag checkid: 'C-WN12-FW-000012_chk'
  tag fixid: 'F-WN12-FW-000012_fix'
  tag version: 'WN12-FW-000012'
  tag ruleid: 'WN12-FW-000012_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000012
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000012
