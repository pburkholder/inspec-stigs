...
title 'WN12-CC-000079 - The Enhanced Mitigation Experience Toolkit (EMET) Default Protections for Internet Explorer must be enabled.'

control 'WN12-CC-000079' do
  impact 0.5
...
'
  tag 'stig','WN12-CC-000079'
  tag severity: 'medium'
  tag checkid: 'C-WN12-CC-000079_chk'
  tag fixid: 'F-WN12-CC-000079_fix'
  tag version: 'WN12-CC-000079'
  tag ruleid: 'WN12-CC-000079_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-CC-000079
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-CC-000079
