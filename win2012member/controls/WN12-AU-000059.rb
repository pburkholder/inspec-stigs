...
title 'WN12-AU-000059 - The system must be configured to audit Object Access - Central Access Policy Staging successes.'

control 'WN12-AU-000059' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000059'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000059_chk'
  tag fixid: 'F-WN12-AU-000059_fix'
  tag version: 'WN12-AU-000059'
  tag ruleid: 'WN12-AU-000059_rule'
  tag fixtext: '
...
Object Access -> Central Access Staging - Success
'

# START_DESCRIBE WN12-AU-000059
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000059
