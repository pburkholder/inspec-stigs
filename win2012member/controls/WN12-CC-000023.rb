...
title 'WN12-CC-000023 - Windows must be prevented from sending an error report when a device driver requests additional software during installation.'

control 'WN12-CC-000023' do
  impact 0.1
...
'
  tag 'stig','WN12-CC-000023'
  tag severity: 'low'
  tag checkid: 'C-WN12-CC-000023_chk'
  tag fixid: 'F-WN12-CC-000023_fix'
  tag version: 'WN12-CC-000023'
  tag ruleid: 'WN12-CC-000023_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-CC-000023
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-CC-000023
