...
title 'WN12-UR-000024 - Unauthorized accounts must not have the Generate security audits user right.'

control 'WN12-UR-000024' do
  impact 0.5
...
'
  tag 'stig','WN12-UR-000024'
  tag severity: 'medium'
  tag checkid: 'C-WN12-UR-000024_chk'
  tag fixid: 'F-WN12-UR-000024_fix'
  tag version: 'WN12-UR-000024'
  tag ruleid: 'WN12-UR-000024_rule'
  tag fixtext: '
Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Local Policies -> User Rights Assignment -> "Generate security audits" to only include the following accounts or groups:
...
# START_DESCRIBE WN12-UR-000024
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-UR-000024
