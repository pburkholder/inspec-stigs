...
title 'WN12-FW-000019 - The Windows Firewall must be enabled for the Public Profile.'

control 'WN12-FW-000019' do
  impact 0.5
...
'
  tag 'stig','WN12-FW-000019'
  tag severity: 'medium'
  tag checkid: 'C-WN12-FW-000019_chk'
  tag fixid: 'F-WN12-FW-000019_fix'
  tag version: 'WN12-FW-000019'
  tag ruleid: 'WN12-FW-000019_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000019
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000019
