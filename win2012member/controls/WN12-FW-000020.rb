...
title 'WN12-FW-000020 - The Windows Firewall must block unsolicited inbound connections for the Public Profile.'

control 'WN12-FW-000020' do
  impact 1.0
...
'
  tag 'stig','WN12-FW-000020'
  tag severity: 'high'
  tag checkid: 'C-WN12-FW-000020_chk'
  tag fixid: 'F-WN12-FW-000020_fix'
  tag version: 'WN12-FW-000020'
  tag ruleid: 'WN12-FW-000020_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000020
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000020
