...
title 'WN12-AU-000060 - The system must be configured to audit Object Access - Central Access Policy Staging failures.'

control 'WN12-AU-000060' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000060'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000060_chk'
  tag fixid: 'F-WN12-AU-000060_fix'
  tag version: 'WN12-AU-000060'
  tag ruleid: 'WN12-AU-000060_rule'
  tag fixtext: '
...
Object Access -> Central Access Staging - Failure
'

# START_DESCRIBE WN12-AU-000060
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000060
