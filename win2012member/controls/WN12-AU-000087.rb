...
title 'WN12-AU-000087 - The system must be configured to audit Policy Change - Authentication Policy Change successes.'

control 'WN12-AU-000087' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000087'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000087_chk'
  tag fixid: 'F-WN12-AU-000087_fix'
  tag version: 'WN12-AU-000087'
  tag ruleid: 'WN12-AU-000087_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000087
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000087
