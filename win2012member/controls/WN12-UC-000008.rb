...
title 'WN12-UC-000008 - Windows Help Ratings feedback must be turned off.'

control 'WN12-UC-000008' do
  impact 0.5
...
'
  tag 'stig','WN12-UC-000008'
  tag severity: 'medium'
  tag checkid: 'C-WN12-UC-000008_chk'
  tag fixid: 'F-WN12-UC-000008_fix'
  tag version: 'WN12-UC-000008'
  tag ruleid: 'WN12-UC-000008_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-UC-000008
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-UC-000008
