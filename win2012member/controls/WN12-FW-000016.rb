...
title 'WN12-FW-000016 - The Windows Firewall log size must be configured for the Private Profile.'

control 'WN12-FW-000016' do
  impact 0.1
...
'
  tag 'stig','WN12-FW-000016'
  tag severity: 'low'
  tag checkid: 'C-WN12-FW-000016_chk'
  tag fixid: 'F-WN12-FW-000016_fix'
  tag version: 'WN12-FW-000016'
  tag ruleid: 'WN12-FW-000016_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000016
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000016
