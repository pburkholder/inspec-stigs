...
title 'WN12-AU-000017 - The system must be configured to audit Account Management - Security Group Management successes.'

control 'WN12-AU-000017' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000017'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000017_chk'
  tag fixid: 'F-WN12-AU-000017_fix'
  tag version: 'WN12-AU-000017'
  tag ruleid: 'WN12-AU-000017_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000017
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000017
