...
title 'WN12-FW-000029 - The Windows Firewall must log successful connections for the Public Profile.'

control 'WN12-FW-000029' do
  impact 0.1
...
'
  tag 'stig','WN12-FW-000029'
  tag severity: 'low'
  tag checkid: 'C-WN12-FW-000029_chk'
  tag fixid: 'F-WN12-FW-000029_fix'
  tag version: 'WN12-FW-000029'
  tag ruleid: 'WN12-FW-000029_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000029
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000029
