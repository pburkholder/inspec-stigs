...
title 'WN12-GE-000021 - Necessary services must be documented to maintain a baseline to determine if additional, unnecessary services have been added to a system.
'

control 'WN12-GE-000021' do
  impact 0.5
...
'
  tag 'stig','WN12-GE-000021'
  tag severity: 'medium'
  tag checkid: 'C-WN12-GE-000021_chk'
  tag fixid: 'F-WN12-GE-000021_fix'
  tag version: 'WN12-GE-000021'
  tag ruleid: 'WN12-GE-000021_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-GE-000021
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-GE-000021
