...
title 'WN12-AU-000080 - The system must be configured to audit Object Access - Registry failures.'

control 'WN12-AU-000080' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000080'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000080_chk'
  tag fixid: 'F-WN12-AU-000080_fix'
  tag version: 'WN12-AU-000080'
  tag ruleid: 'WN12-AU-000080_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000080
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000080
