...
title 'WN12-AU-000086 - The system must be configured to audit Policy Change - Audit Policy Change failures.'

control 'WN12-AU-000086' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000086'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000086_chk'
  tag fixid: 'F-WN12-AU-000086_fix'
  tag version: 'WN12-AU-000086'
  tag ruleid: 'WN12-AU-000086_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000086
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000086
