...
title 'WN12-AU-000109 - The system must be configured to audit System - Security System Extension successes.'

control 'WN12-AU-000109' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000109'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000109_chk'
  tag fixid: 'F-WN12-AU-000109_fix'
  tag version: 'WN12-AU-000109'
  tag ruleid: 'WN12-AU-000109_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000109
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000109
