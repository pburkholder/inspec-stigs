...
title 'WN12-AU-000108 - The system must be configured to audit System - Security State Change failures.'

control 'WN12-AU-000108' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000108'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000108_chk'
  tag fixid: 'F-WN12-AU-000108_fix'
  tag version: 'WN12-AU-000108'
  tag ruleid: 'WN12-AU-000108_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000108
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000108
