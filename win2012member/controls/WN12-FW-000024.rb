...
title 'WN12-FW-000024 - The Windows Firewall local connection rules must not be merged with Group Policy settings for the Public Profile.'

control 'WN12-FW-000024' do
  impact 0.5
...
'
  tag 'stig','WN12-FW-000024'
  tag severity: 'medium'
  tag checkid: 'C-WN12-FW-000024_chk'
  tag fixid: 'F-WN12-FW-000024_fix'
  tag version: 'WN12-FW-000024'
  tag ruleid: 'WN12-FW-000024_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000024
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000024
