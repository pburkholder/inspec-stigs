...
title 'WN12-CC-000036 - The Internet Connection Wizard must not download a list of Internet Service Providers (ISPs) from Microsoft.'

control 'WN12-CC-000036' do
  impact 0.1
...
'
  tag 'stig','WN12-CC-000036'
  tag severity: 'low'
  tag checkid: 'C-WN12-CC-000036_chk'
  tag fixid: 'F-WN12-CC-000036_fix'
  tag version: 'WN12-CC-000036'
  tag ruleid: 'WN12-CC-000036_rule'
  tag fixtext: '
...
Registry Path: \Software\Policies\Microsoft\Windows\Internet Connection Wizard\
...
# START_DESCRIBE WN12-CC-000036
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-CC-000036
