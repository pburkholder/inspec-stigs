...
title 'WN12-AU-000074 - The system must be configured to audit Object Access - Handle Manipulation failures.'

control 'WN12-AU-000074' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000074'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000074_chk'
  tag fixid: 'F-WN12-AU-000074_fix'
  tag version: 'WN12-AU-000074'
  tag ruleid: 'WN12-AU-000074_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000074
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000074
