...
title 'WN12-AU-000101 - The system must be configured to audit Privilege Use - Sensitive Privilege Use successes.'

control 'WN12-AU-000101' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000101'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000101_chk'
  tag fixid: 'F-WN12-AU-000101_fix'
  tag version: 'WN12-AU-000101'
  tag ruleid: 'WN12-AU-000101_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000101
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000101
