...
title 'WN12-CC-000010 - The Teredo IPv6 transition technology must be disabled.'

control 'WN12-CC-000010' do
  impact 0.5
...
'
  tag 'stig','WN12-CC-000010'
  tag severity: 'medium'
  tag checkid: 'C-WN12-CC-000010_chk'
  tag fixid: 'F-WN12-CC-000010_fix'
  tag version: 'WN12-CC-000010'
  tag ruleid: 'WN12-CC-000010_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-CC-000010
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-CC-000010
