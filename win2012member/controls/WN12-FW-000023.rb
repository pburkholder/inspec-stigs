...
title 'WN12-FW-000023 - The Windows Firewall must block unicast responses to multicast or broadcast messages for the Public Profile.'

control 'WN12-FW-000023' do
  impact 0.5
...
'
  tag 'stig','WN12-FW-000023'
  tag severity: 'medium'
  tag checkid: 'C-WN12-FW-000023_chk'
  tag fixid: 'F-WN12-FW-000023_fix'
  tag version: 'WN12-FW-000023'
  tag ruleid: 'WN12-FW-000023_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000023
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000023
