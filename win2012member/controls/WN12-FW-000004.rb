...
title 'WN12-FW-000004 - The Windows Firewall must display notifications when a program is blocked from receiving an inbound connection for the Domain Profile.'

control 'WN12-FW-000004' do
  impact 0.1
  ...
  desc '
A firewall provides a line of defense against attack.  To be effective, it must be enabled and properly configured.  The display of notifications to the user when a program is blocked from receiving an inbound connection in the domain must be enabled to alert the user of potential issues.
'
  tag 'stig','WN12-FW-000004'
  tag severity: 'low'
  tag checkid: 'C-WN12-FW-000004_chk'
  tag fixid: 'F-WN12-FW-000004_fix'
  tag version: 'WN12-FW-000004'
  tag ruleid: 'WN12-FW-000004_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000004
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000004
