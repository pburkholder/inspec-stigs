...
title 'WN12-AU-000104 - The system must be configured to audit System - IPSec Driver failures.'

control 'WN12-AU-000104' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000104'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000104_chk'
  tag fixid: 'F-WN12-AU-000104_fix'
  tag version: 'WN12-AU-000104'
  tag ruleid: 'WN12-AU-000104_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000104
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000104
