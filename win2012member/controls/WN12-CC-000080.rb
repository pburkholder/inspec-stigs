...
title 'WN12-CC-000080 - The Enhanced Mitigation Experience Toolkit (EMET) Default Protections for Recommended Software must be enabled.'

control 'WN12-CC-000080' do
  impact 0.5
...
'
  tag 'stig','WN12-CC-000080'
  tag severity: 'medium'
  tag checkid: 'C-WN12-CC-000080_chk'
  tag fixid: 'F-WN12-CC-000080_fix'
  tag version: 'WN12-CC-000080'
  tag ruleid: 'WN12-CC-000080_rule'
  tag fixtext: '
EMET 4.0
...
# START_DESCRIBE WN12-CC-000080
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-CC-000080
