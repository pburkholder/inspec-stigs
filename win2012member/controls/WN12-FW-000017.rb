...
title 'WN12-FW-000017 - The Windows Firewall must log dropped packets for the Private Profile.'

control 'WN12-FW-000017' do
  impact 0.1
...
'
  tag 'stig','WN12-FW-000017'
  tag severity: 'low'
  tag checkid: 'C-WN12-FW-000017_chk'
  tag fixid: 'F-WN12-FW-000017_fix'
  tag version: 'WN12-FW-000017'
  tag ruleid: 'WN12-FW-000017_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-FW-000017
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-FW-000017
