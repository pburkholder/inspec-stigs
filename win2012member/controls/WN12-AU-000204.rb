...
title 'WN12-AU-000204 - Permissions for the Application event log must prevent access by nonprivileged accounts.'

control 'WN12-AU-000204' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000204'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000204_chk'
  tag fixid: 'F-WN12-AU-000204_fix'
  tag version: 'WN12-AU-000204'
  tag ruleid: 'WN12-AU-000204_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000204
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000204
