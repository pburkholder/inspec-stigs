...
title 'WN12-AU-000047 - The system must be configured to audit Logon/Logoff - Logon successes.'

control 'WN12-AU-000047' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000047'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000047_chk'
  tag fixid: 'F-WN12-AU-000047_fix'
  tag version: 'WN12-AU-000047'
  tag ruleid: 'WN12-AU-000047_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000047
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000047
