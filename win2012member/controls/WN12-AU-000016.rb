...
title 'WN12-AU-000016 - The system must be configured to audit Account Management - Other Account Management Events failures.'

control 'WN12-AU-000016' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000016'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000016_chk'
  tag fixid: 'F-WN12-AU-000016_fix'
  tag version: 'WN12-AU-000016'
  tag ruleid: 'WN12-AU-000016_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000016
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000016
