...
title 'WN12-UR-000029 - Unauthorized accounts must not have the Lock pages in memory user right.'

control 'WN12-UR-000029' do
  impact 0.5
...
'
  tag 'stig','WN12-UR-000029'
  tag severity: 'medium'
  tag checkid: 'C-WN12-UR-000029_chk'
  tag fixid: 'F-WN12-UR-000029_fix'
  tag version: 'WN12-UR-000029'
  tag ruleid: 'WN12-UR-000029_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-UR-000029
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-UR-000029
