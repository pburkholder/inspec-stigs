...
title 'WN12-UR-000007 - Unauthorized accounts must not have the Back up files and directories user right.'

control 'WN12-UR-000007' do
  impact 0.5
...
'
  tag 'stig','WN12-UR-000007'
  tag severity: 'medium'
  tag checkid: 'C-WN12-UR-000007_chk'
  tag fixid: 'F-WN12-UR-000007_fix'
  tag version: 'WN12-UR-000007'
  tag ruleid: 'WN12-UR-000007_rule'
  tag fixtext: '
Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Local Policies -> User Rights Assignment -> "Back up files and directories" to only include the following accounts or groups:
...
# START_DESCRIBE WN12-UR-000007
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-UR-000007
