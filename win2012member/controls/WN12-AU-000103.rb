...
title 'WN12-AU-000103 - The system must be configured to audit System - IPSec Driver successes.'

control 'WN12-AU-000103' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000103'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000103_chk'
  tag fixid: 'F-WN12-AU-000103_fix'
  tag version: 'WN12-AU-000103'
  tag ruleid: 'WN12-AU-000103_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000103
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000103
