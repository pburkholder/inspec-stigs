...
title 'WN12-AU-000001 - The system must be configured to audit Account Logon - Credential Validation successes.'

control 'WN12-AU-000001' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000001'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000001_chk'
  tag fixid: 'F-WN12-AU-000001_fix'
  tag version: 'WN12-AU-000001'
  tag ruleid: 'WN12-AU-000001_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000001
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000001
