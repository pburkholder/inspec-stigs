...
title 'WN12-AU-000011 - The system must be configured to audit Account Logon - Computer Account Management successes.'

control 'WN12-AU-000011' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000011'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000011_chk'
  tag fixid: 'F-WN12-AU-000011_fix'
  tag version: 'WN12-AU-000011'
  tag ruleid: 'WN12-AU-000011_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000011
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000011
