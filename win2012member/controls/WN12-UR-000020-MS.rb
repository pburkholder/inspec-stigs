...
title 'WN12-UR-000020-MS - The Deny log on locally user right on member servers must be configured to prevent access from highly privileged domain accounts on domain systems, and from unauthenticated access on all systems.'

control 'WN12-UR-000020-MS' do
  impact 0.5
...
'
  tag 'stig','WN12-UR-000020-MS'
  tag severity: 'medium'
  tag checkid: 'C-WN12-UR-000020-MS_chk'
  tag fixid: 'F-WN12-UR-000020-MS_fix'
  tag version: 'WN12-UR-000020-MS'
  tag ruleid: 'WN12-UR-000020-MS_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-UR-000020-MS
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-UR-000020-MS
