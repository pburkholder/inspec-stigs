...
title 'WN12-CC-000035 - Errors in handwriting recognition on tablet PCs must not be reported to Microsoft.'

control 'WN12-CC-000035' do
  impact 0.1
...
'
  tag 'stig','WN12-CC-000035'
  tag severity: 'low'
  tag checkid: 'C-WN12-CC-000035_chk'
  tag fixid: 'F-WN12-CC-000035_fix'
  tag version: 'WN12-CC-000035'
  tag ruleid: 'WN12-CC-000035_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-CC-000035
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-CC-000035
