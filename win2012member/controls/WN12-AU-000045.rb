...
title 'WN12-AU-000045 - The system must be configured to audit Logon/Logoff - Logoff successes.'

control 'WN12-AU-000045' do
  impact 0.5
...
'
  tag 'stig','WN12-AU-000045'
  tag severity: 'medium'
  tag checkid: 'C-WN12-AU-000045_chk'
  tag fixid: 'F-WN12-AU-000045_fix'
  tag version: 'WN12-AU-000045'
  tag ruleid: 'WN12-AU-000045_rule'
  tag fixtext: '
...
# START_DESCRIBE WN12-AU-000045
  # describe file('/etc') do
  #   it { should be_directory }
  # end
# END_DESCRIBE WN12-AU-000045
